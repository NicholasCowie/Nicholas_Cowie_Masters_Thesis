...
transformed parameters {
    ...
    real enzyme_denom[N_experiment, N_enzyme];
  ...
  for (e in 1:N_experiment){
    ...
    //                                 1e-9, 1e-12, 1e5
    //                               );
    enzyme_flux[e, ] = to_array_1d(get_enzyme_fluxes(conc_sim[e, balanced_mic_ix], to_array_1d(parameter)));
    enzyme_denom[e, ] = to_array_1d(get_enzyme_denom(conc_sim[e, balanced_mic_ix], to_array_1d(parameter)));
