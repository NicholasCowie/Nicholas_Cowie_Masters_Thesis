...
vector get_enzyme_fluxes(real[] m, real[] p){
real empty_array[0];
real Tr_PGI = p[10]*p[60]
              * (p[7]/p[58])^(-1*-1) 
              - p[10]*p[60]/p[34]
...
return [
  ...
  modular_rate_law(Tr_FBA, Dr_FBA, Dr_reg_FBA),
  modular_rate_law(Tr_TPI, Dr_TPI, Dr_reg_TPI),
  modular_rate_law(Tr_TDH1, Dr_TDH1, Dr_reg_TDH1),
  modular_rate_law(Tr_TDH3, Dr_TDH3, Dr_reg_TDH3),
  modular_rate_law(Tr_PGK, Dr_PGK, Dr_reg_PGK)*get_regulatory_effect({p[2]},empty_array,free_enzyme_ratio_PGK,{p[95]},empty_array,p[96]),
  modular_rate_law(Tr_GPM1, Dr_GPM1, Dr_reg_GPM1),
  modular_rate_law(Tr_ENO1, Dr_ENO1, Dr_reg_ENO1),
  modular_rate_law(Tr_ENO2, Dr_ENO2, Dr_reg_ENO2),
  modular_rate_law(Tr_CDC19, Dr_CDC19, Dr_reg_CDC19)*get_regulatory_effect({m[4]},empty_array,free_enzyme_ratio_CDC19,{p[111]},empty_array,p[112]),
  modular_rate_law(Tr_ZWF1, Dr_ZWF1, Dr_reg_ZWF1),
  modular_rate_law(Tr_SOL3, Dr_SOL3, Dr_reg_SOL3),
  modular_rate_law(Tr_GND1, Dr_GND1, Dr_reg_GND1),
...
vector get_enzyme_denom(real[] m, real[] p){
real empty_array[0];
real Tr_PGI = p[10]*p[60]
              * (p[7]/p[58])^(-1*-1) 
              - p[10]*p[60]/p[34]
...
return [
  ...
  return {
    ...
    1*fluxes[3]-1*fluxes[4]-1*fluxes[21],
    1*fluxes[8]-1*fluxes[9],
    1*fluxes[9]-1*fluxes[18]-1*fluxes[20],
    1*fluxes[10]-1*fluxes[11],
    1*fluxes[11]-1*fluxes[12],
    1*fluxes[12]-1*fluxes[13]-1*fluxes[14],
    1*fluxes[14]-1*fluxes[15]-1*fluxes[22],
...
return [
  0,
  get_regulatory_effect({m[3]},{p[1]},free_enzyme_ratio_PFK,{p[66]},{p[68]},p[67]),
  0,
  0,
  0,
  get_regulatory_effect({p[2]},empty_array,free_enzyme_ratio_PGK,{p[95]},empty_array,p[96]),
  0,
  0,
  get_regulatory_effect({m[4]},empty_array,free_enzyme_ratio_CDC19,{p[111]},empty_array,p[112]),
  0,
  0,
  0,
  0,
...
transformed parameters {
  ...
  real enzyme_flux[N_experiment, N_enzyme];
  real enzyme_sat[N_experiment, N_enzyme];
  real initial_time = 0;
  ...
  for (e in 1:N_experiment){
    ...
    //                                 1e-9, 1e-12, 1e5
    //                               );
    enzyme_flux = to_array_1d(get_enzyme_fluxes(conc_sim[e, balanced_mic_ix], to_array_1d(parameter)));
    enzyme_sat = to_array_1d(get_enzyme_sat(conc_sim[e, balanced_mic_ix], to_array_1d(parameter)));
